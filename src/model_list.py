...
MODEL_MAPPING = {
    ...
    "mistral-community/Mixtral-8x22B-v0.1-AWQ": ["141.0", "Base"],
    ...
    "alpindale/c4ai-command-r-plus-GPTQ": ["104.0", "Chat"],
    "meta-llama/Meta-Llama-3-70B-Instruct": ["70.0", "Chat", "meta-llama/Meta-Llama-3-70B"],
    "MaziyarPanahi/Mixtral-8x22B-Instruct-v0.1-AWQ": ["141.0", "Chat", "mistral-community/Mixtral-8x22B-v0.1-AWQ"],
    "MaziyarPanahi/zephyr-orpo-141b-A35b-v0.1-AWQ": ["141.0", "Chat", "mistral-community/Mixtral-8x22B-v0.1-AWQ"],
